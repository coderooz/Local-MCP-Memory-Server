...
export function getTools() {
    return [
        ...
        {
            name: "open_browser",
            description: "Initialize and open a browser session for automation. Returns sessionId for subsequent operations.",
            inputSchema: {
                type: "object",
                properties: {
                    sessionId: { type: "string", description: "Optional session ID. Auto-generated if not provided." }
                }
            }
        },
        {
            ...
            inputSchema: {
                type: "object",
                properties: {
                    sessionId: { type: "string", description: "Session ID to close. Closes all if not provided." }
                }
            }
        },
        {
        ...
        },
        {
            ...
            description: "Execute JavaScript in the browser context. Requires active session. Dangerous patterns are blocked.",
            inputSchema: {
                type: "object",
                properties: {
                    sessionId: { type: "string", description: "Session ID from open_browser" },
        ...
        },
        {
            ...
            description: "Get list of active browser sessions. Utility tool for multi-agent coordination.",
            inputSchema: {
                type: "object",
                properties: {}
            }
