...
- FORBIDDEN keys: port, pid, runtime, password, secret\_, token, etc.
...
**Standalone Chaos Test Script**

- Added `scripts/chaos-test.js`:
...
## [v1.1.0] - Major Refactor & MCP Stabilization
...
- Updated `package.json`:
  - Added scripts: `start`, `start:api`, `check`, `test`
